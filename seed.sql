...
INSERT INTO `images` VALUES (1,'https://www.cataloniahotels.com/es/blog/wp-content/uploads/2024/01/tipos-habitaciones-hotel.jpg'),(2,'https://www.sofitelbarucalablanca.com/wp-content/uploads/sites/19/2023/04/DUF_8644-v-ok-1170x780.jpg'),(3,'https://media.revistaad.es/photos/65c21a5605ba5d3cad2a23ba/16:9/w_2560%2Cc_limit/atr.royalmansion-bedroom2-mr.jpg'),(4,'https://www.hotelvalencialasarenas.com/wp-content/blogs.dir/1493/files/cabeceras//header_hab.jpg'),(5,'https://www.infobae.com/new-resizer/JSigyxlGx_G2D-A1YVRvZiwuoec=/filters:format(webp):quality(85)/s3.amazonaws.com/arc-wordpress-client-uploads/infobae-wp/wp-content/uploads/2019/05/20152451/Mandarin-Oriental-Hong-Kong-3.jpg');
...
INSERT INTO `migrations` VALUES (1,'0001_01_01_000000_create_users_table',1),(2,'0001_01_01_000001_create_cache_table',1),(3,'0001_01_01_000002_create_jobs_table',1),(4,'2024_09_04_142135_create_personal_access_tokens_table',2),(5,'2024_09_04_142623_create_activities_table',3),(6,'2024_09_06_112729_add_description_to_activities_table',4);
...
CREATE TABLE `room_types_images` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `roomType` (`room_type_id`,`image_id`),
...
INSERT INTO `users` VALUES (1,'Test','test@gmail',NULL,'password',NULL,NULL,NULL),(2,'John Doe','john@example.com',NULL,'password',NULL,'2024-09-06 11:08:18','2024-09-06 11:08:18');
